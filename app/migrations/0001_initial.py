# Generated by Django 3.2 on 2022-05-13 04:27
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('title', models.CharField(default='', max_length=200)),
                ('img_product', models.FileField(storage=gdstorage.storage.GoogleDriveStorage(), upload_to='uploads/')),
                ('description', models.TextField(default='')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('customeruser', models.ForeignKey(on_delete=models.Model, to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            name='Gallery',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('img', models.FileField(storage=gdstorage.storage.GoogleDriveStorage(), upload_to='uploads/')),
                ('product', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='app.product')),
            ],
        ),
        migrations.CreateModel(
