# Generated by Django 3.2 on 2022-05-16 03:12
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('title', models.CharField(default='', max_length=200)),
                ('img_product', models.FileField(storage=gdstorage.storage.GoogleDriveStorage(), upload_to='maps/')),
                ('description', models.TextField(default='')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('img', models.FileField(storage=gdstorage.storage.GoogleDriveStorage(), upload_to='maps/')),
                ('product', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='app.product')),
            ],
        ),
        migrations.CreateModel(
